...
type LinkPreviewOptions struct {
	...
	// Optional. True, if the media in the link preview is supposed
	...
	// Optional. True, if the link preview must be shown above
	// the message text; otherwise, the link preview will be
