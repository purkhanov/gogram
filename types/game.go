...
type Game struct {
	...
	// included in the game message. Can be automatically edited
	// to include current high scores for the game when the bot
	// calls setGameScore, or manually edited using editMessageText.
	// 0-4096 characters.
	...
	// Optional. Animation that will be displayed in
